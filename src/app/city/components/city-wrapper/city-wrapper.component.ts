...
// import { mfSubject, mfModules } from 'shell/Connect';

@Component({
  selector: 'app-city-wrapper',
  templateUrl: './city-wrapper.component.html',
  styleUrls: ['./city-wrapper.component.scss']
})
export class CityWrapperComponent implements OnInit {
  ...
  openModule(exposedModule: string) {
    const event = new CustomEvent('onMount', { detail: exposedModule });
